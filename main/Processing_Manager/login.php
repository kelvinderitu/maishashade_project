...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['email']) || empty($_POST['password'])) {
    	...
    	$statement = $pdo->prepare("SELECT * FROM tbl_staff WHERE email=? AND status=? AND role='supervisor'");
	...
	<div class="login-logo">
  	...
  	<div class="login-box-body">
		...
		<form action="" method="post">
			...
			<div class="container">
				<button><a href="../index.php" style="color:black;">Back</a><br></button>
	</div>
		</form>
	</div>
</div>
