...
if(isset($_POST['send'])) {    
    ...
    $sql="INSERT INTO  requestsproduct(varietyName,quantity,specs,supplier,DueDate) VALUES(:varietyName,:quantity,:specs,:supplier,:DueDate)";
        ...
        <div class="row">
            <!-- Map Column -->
              <div class="col-lg-8 mb-4">
                ...
                <center><h5><b>REQUEST PRODUCT :</b></h5></center>
                ...
                <form name="sentaddress"  method="post">
                    ...
                    <div class="col-xl-6">
                        ...
                        if ($num > 0){
                          ...
                          echo'<option value="'.$rows['varietyName'].'" >'.$rows['varietyName'].'</option>';
                              }
                                  echo '</select>';
                              }
                            ?>  
...
<textarea rows="5" cols="36" name="specs" required class="form-control"></textarea>
                    ...
                    <div class="col-xl-6">
                        <label class="form-control-label">Select Supplier<span class="text-danger ml-2">*</span></label>
                         <?php
                        $qry= "SELECT * FROM tbl_staff where role='farmer' and status='1'";
                        $result = $conn->query($qry);
                        $num = $result->num_rows;		
                        if ($num > 0){
