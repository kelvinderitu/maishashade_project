...
<body class="hold-transition fixed skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo" style="background-color:#458F46">
				<span class="logo-lg">Harrow Lighting Company</span>
			</a>

			<nav class="navbar navbar-static-top" style="background-color:#458F46">
				
				<a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
					<span class="sr-only">Toggle navigation</span>
				</a>

				<span style="float:left;line-height:50px;color:#fff;padding-left:15px;font-size:18px;">Supervisor Panel</span>
						...
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu">
								<li class="user-footer">
									...
									<div>
										<a href="logout2.php" class="btn btn-default btn-flat">Log out</a>
									</div>
								</li>
							</ul>
						</li>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
					...
					<li class="treeview <?php if( ($cur_page == 'order.php') ) {echo 'active';} ?>">
                        <a href="instock.php">
                            <i class="fa fa-sticky-note"></i> <span>Stock</span>
                        </a>
                    </li>-->
					<li class="treeview <?php if( ($cur_page == 'order.php') ) {echo 'active';} ?>">
                        <a href="Request2.php">
