            	...
            	foreach ($result as $row) {
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <td>
                            ...
                            <br>
                           <!-- <?php
                            if($row['photographer_status']=='Pending') {
                                    ?>
                                    <a href="delivery-change-status.php?id=<?php echo $row['id']; ?>&task=Delivered" class="btn btn-success btn-xs" style="width:100%;margin-bottom:4px;">Service Delivered</a>
                                    <?php
                            }
                            ?>-->
                              <?php
                            if($row['landsize']=='0') {
                                if($row['supervisor_status']=='Pending') {
                                    ?>
                                    <a href="quotations.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-xs" style="width:100%;margin-bottom:4px;">File Report</a>
                                    <?php
                            }}
                            ?><br>
                        </td>
