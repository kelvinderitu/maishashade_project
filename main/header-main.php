			...
			<div class="col-md-5 right">
				<ul>
					...
					if(isset($_SESSION['customer'])) {
						...
						<li><a href="dashboard.php"><i class="fa fa-gear"></i> My Dashboard</a></li>
	<li><a href="myspecialorders.php"><font color="black"><i class="fa fa-briefcase"></i> My Special Order</font></a></li>
				
						<?php
					} else {
						?>
						<button class="btn btn-sm btn-success"><li><a href="login.php"><i class="fa fa-sign-in"></i> CUSTOMER LOGIN</a></li></button>
						<button class="btn btn-sm btn-success"><li><a href="registration.php"><i class="fa fa-user-plus"></i> REGISTER</a></li></button>
						<button class="btn btn-sm btn-success"><li><a href="login-staff.php"><i class="fa fa-sign-in"></i> STAFF LOGIN</a></li></button><br><hr>
						<button class="btn btn-sm btn-success"><li><a href="contactus.php"><i class="fa fa-comment"></i> FEEDBACK</a></li></button>
						<?php	
					}
					?>
<br><hr>
					<button class="btn btn-sm btn-warning"><li><a href="cart.php"><i class="fa fa-shopping-cart"></i> <?php echo LANG_VALUE_18; ?> (Ksh<?php  ?><?php
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 pl_0 pr_0">
				<div class="menu-container"style="background-color:maroon" >
					<div class="menu">
						<ul>
