...
<!-- MENU SECTION END-->
    ...
    <div class="container">
    <button class="btn btn-sm btn-primary"><a href="send-message.php"><font color="white"><i class="fa fa-edit"></i>&nbsp;Compose New</font></a></button>
</div>
        </div>
            <div class="row">
                <div class="col-md-12">
...
<?php                                      $sql = "SELECT *FROM tbmessages where recepient='finance' or sender='finance'";
$query = $dbh -> prepare($sql);
$query->execute();
