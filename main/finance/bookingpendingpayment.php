                ...
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            <?php
                            $i = 0;
                            $statement = $pdo->prepare("SELECT * FROM tbl_bookings WHERE  payment_status='Pending'");
                            $statement->execute();
                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                            foreach ($result as $row) {
                                $i++;
                                ...
                                <tr class="<?php if ($row['payment_status'] == 'Pending') {
                                    ...
                                    <td>
                                        ...
                                        foreach ($result1 as $row1) {
                                            ...
                                            echo '<br><b>Charges:</b> ' . ($row1['pricing'] + $row['fee']);
                                            echo '<br><br>';
                                        }
                                        ?>
                                    </td>
                                    <td>
                                        <b>Amount Paid: </b><?php echo $row['charges'] + $row['fee']; ?><br>
