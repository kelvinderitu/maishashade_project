                ...
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            <?php
                            $i = 0;
                            $statement = $pdo->prepare("SELECT * FROM tbl_payment WHERE  payment_status='Pending'ORDER by id DESC");
                            $statement->execute();
                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                            foreach ($result as $row) {
                                $i++;
                                    ...
                                    <td>
                                        ...
                                        ?>
                                            ...
                                            ?>
                                                ...
                                                <a href="order-change-status-rejected.php?id=<?php echo $row['id']; ?>&task=Rejected&task2=Rejected" class="btn btn-xs" style="width:100%; margin-bottom:4px; background-color: red; color: white;">Reject</a>
