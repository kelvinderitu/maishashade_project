...
if (isset($_POST['update_product_btn'])) {
    ...
    $update_product_query = "UPDATE tbl_bank SET BankName='$bankname', BankAccountNumber='$bankaccount' WHERE id='$bank_id' ";

    $update_product_query_run  = mysqli_query($con, $update_product_query);

    if ($update_product_query_run) {
        
        redirect("bankdetails.php?id=$bank_id", "Bank updated successfully");
    } else {
        redirect("bankdetails.php?id=$bank_id", "Something went wrong");
    }
} 
                            ...
                            <form role ="form" action="" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <a href="bankdetails.php" class="btn btn-primary float-right">Back</a>
                                    </div>
                                </div>
                            </form>
