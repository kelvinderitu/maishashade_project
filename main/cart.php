...
<div class="page">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
            <center><h3>Shopping Cart List</h3></center>
                    ...
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a onclick="return confirmDelete();" href="cart-item-delete.php?id=<?php echo $arr_cart_p_id[$i]; ?>&size=<?php echo $arr_cart_size_id[$i]; ?>&color=<?php echo $arr_cart_color_id[$i]; ?>" class="trash">Delete<i class="fa fa-trash" style="color:red;"></i></a>
                            </td>
                        </tr>
                        <?php endfor; ?>
                        <tr>
               ...
               <center> <h3><b>Proceed To Checkout</b></h3>
                <div class="">
                    <ul>  
                        <a href="checkout.php" class="btn btn-success">With Shipping</a>
                        <a href="checkout-free.php" class="btn btn-primary">With No Shipping</a>
