        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="user-content">
                    <center><h3><font color="black">MY ORDER HISTORY</font></h3></center>
<button class="btn btn-info"><a href="index.php"><font color="black">Back</font></a></button><br><br>
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>Payment Details</th></th>
                                    <th>Location Details</th></th>
                                    <th>Order Status</th>
            ...
            ?>
                        ...
                        <td>
                        <a href="customer-receipt.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-md" >Recipt</a> <br><br>
                        <?php
                                if($row['cust_remark']==''){
