...
// Check if 'size' is set, otherwise set a default value or handle it accordingly
$defaultSize = 'Default Size'; // Change this to your default size if needed
foreach($arr_cart_size_name as &$size) {
    if(empty($size)) {
        $size = $defaultSize;
    }
}
...
// Check if 'color' is set, otherwise set a default value or handle it accordingly
$defaultColor = 'Default Color'; // Change this to your default color if needed
foreach($arr_cart_color_name as &$color) {
    if(empty($color)) {
        $color = $defaultColor;
    }
}
