...
<div class="product bg-gray pt_70 pb_30">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    <font color="black"><h2> PRODUCTS </h2></font>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="product-carousel" >
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                <h3>Name :<a href="product.php?id=<?php echo $row['p_id']; ?>"><?php echo $row['p_name']; ?></a></h3>
                                <h3>Description :<a href="product.php?id=<?php echo $row['p_id']; ?>"><?php echo $row['p_description']; ?></a></h3>
