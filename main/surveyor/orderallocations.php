    ...
    <div class="row">
                ...
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            <?php
                            $i = 0;
                            $statement = $pdo->prepare("SELECT * FROM tbl_payment WHERE  technician_status='Pending' and technician='" . $_SESSION['user']['full_name'] . "'");
                            $statement->execute();
                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                            foreach ($result as $row) {
                                $i++;
        ...
        <input type="submit" name="complete" value="Complete">
                                    ...
                                    ?>-->
                                        ...
                                        ?>
                                        <?php
                                        if ($row['technician_request'] == 'pending') {
                                        ?>
                                            <a href="requesttool.php?id=<?php echo $row['id']; ?>&task=Approve &task2=Not Confirmed" class="btn btn-success btn-xs" style="width:100%;margin-bottom:4px;">Request Toolbox</a>
                                        <?php
                                        }
                                        ?>
                                        <?php
                                        ...
                                        ?>
                                        <a href="materials.php?id=<?php echo $row['id']; ?>&task=pending" class="btn btn-success btn-xs" style="width:100%;margin-bottom:4px;">Request Materials</a>
                                        <?php
                                        ?>
                                        <a href="approvedmaterials.php?id=<?php echo $row['id']; ?>&task=pending" class="btn btn-success btn-xs" style="width:100%;margin-bottom:4px;">Approved Materials</a>
                                        <?php
