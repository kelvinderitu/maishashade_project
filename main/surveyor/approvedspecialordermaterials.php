...
<section class="content-header">
    <div class="content-header-left">
        ...
        <div class="btn btn-float-right"> <a class="btn  btn-warning" href="specialorders.php?dashboard">Back</a></div>
    </div>
</section>
                ...
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            <?php
                            $i = 0;
                            $statement = $pdo->prepare("SELECT * FROM tbl_requestedspecialordermaterials WHERE  status='Approved'AND technician_name='" . $_SESSION['user']['full_name'] . "'");
                            $statement->execute();
                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                            foreach ($result as $row) {
                                $i++;
