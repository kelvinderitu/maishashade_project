            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <b>Land Size:</b><br> <?php echo $row['lndsize']; ?><br><br>
                        <b>Registration:</b><br> <?php echo $row['reg']; ?><br><br>
                        <b>Slope of Land:</b><br> <?php echo $row['slope']; ?><br><br>
                        <b>Soil Depth (Feet):</b><br> <?php echo $row['depth']; ?><br><br>
                        <b>Recommendation:</b><br> <?php echo $row['recommandation']; ?><br><br>
                        </td>
                        <td>
