                                ...
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" action="" method="post">
                                        <div class="form-group">
                                            <input type="hidden" name="customer_id" value="<?php echo $row['cust_id']; ?>"><br>

                                            <label>Customer Name</label>
                                            
                                            <input class="form-control" type="text" readonly name="customer_fullName" value='<?php echo $row['cust_name'] . " " . $row['cust_lname']; ?>' required>
                                        </div>
                                        </br>
                                        <div class="form-group">
                                        ...
                                        <div class="btn btn-float-right"> <a class="btn  btn-warning" href="myallocation.php">Back</a></div>
                                    </form>
                                </div>
                            </div>
                            <!-- /.row (nested) -->
