	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<nav class="navbar navbar-static-top" style="background-color:#ADD8E6">
				...
				<span style="float:left;line-height:50px;color:#fff;padding-left:15px;font-size:18px;">Driver Panel</span>
      			...
      			<ul class="sidebar-menu">
                    ...
                    <li class="treeview <?php if( ($cur_page == 'product.php') || ($cur_page == 'product-add.php') || ($cur_page == 'product-edit.php') ) {echo 'active';} ?>">
                        <a href="myallocation.php">
                            <i class="fa fa-truck"></i> <span>Pending Deliveries Allocations</span>
                        </a>
                    </li>
					
                    <li class="treeview <?php if( ($cur_page == 'product.php') || ($cur_page == 'product-add.php') || ($cur_page == 'product-edit.php') ) {echo 'active';} ?>">
                        <a href="myserviceallocation.php">
