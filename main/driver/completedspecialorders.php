...
<section class="content-header">
    <div class="content-header-left">
        <h3>My Special orders Deliveries</h3>
    </div>
</section>
                ...
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            <?php
                            $i = 0;
                            $statement = $pdo->prepare("SELECT * FROM tbl_specialorders where shipping_status='Goods Delivered' and driver='" .$_SESSION['user']['full_name'] . "'ORDER by id DESC");
                            $statement->execute();
                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                            foreach ($result as $row) {
                                $i++;
                            ?>
                                <tr class="<?php if ($row['payment_status'] == 'pending') {
                                    ...
                                    <td>
                                        ...
                                        ?>
                                                <a href="special-order-change.php?id=<?php echo $row['id']; ?>&task=Completed" class="btn btn-warning btn-xs" style="width:100%;margin-bottom:4px;">Mark Complete</a>
                                        <?php
                                            }
                                        }
                                        ?>
