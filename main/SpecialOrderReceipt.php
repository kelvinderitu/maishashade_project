...
<div class="table-responsive">
    <table class="table table-striped table-hover">
        ...
        <tbody>
            ...
            $id = $_GET['id'];
            $statement = $pdo->prepare("SELECT * FROM tbl_specialorders where id='$id' and customer_email=? ORDER BY id DESC LIMIT $start, $limit");
            $statement->execute(array($_SESSION['customer']['cust_email']));
                ...
                <div class="card ">
                    <tr>
                        <center>
                            ...
                            <td>
                                <center>
                                    <b>Product :</b><?php echo $row['product details']; ?><br><br>
                                    <b>Date :</b><?php echo $row['payment_date']; ?><br>
                                    <b>Transaction id :</b><?php echo $row['transaction_info']; ?><br>
