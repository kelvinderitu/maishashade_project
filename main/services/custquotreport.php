            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <b>Land Size:</b><br> <?php echo $row['landsize']; ?><br>
                        <b>Building Style:</b><br> <?php echo $row['style']; ?><br>
                        <b>No of Floors:</b><br> <?php echo $row['floors']; ?><br><br>
                        </td>
                        <td>
                        <b>Permits Cost :</b><br> <?php echo $row['permit']; ?><br>
                        <b>Material Cost:</b><br> <?php echo $row['materialcost']; ?><br>
                        <b>Labour Cost:</b><br> <?php echo $row['labourcost']; ?><br><br>
                        <b>ESTMATED TOTAL :<br> <?php echo $row['materialcost']+$row['materialcost']+$row['labourcost']; ?></b><br>
                        </td>
	                </tr>
            		<?php
            	}
