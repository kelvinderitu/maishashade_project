...
$sql="SELECT * FROM upload where client='".$_SESSION['customer']['cust_name']."'";
...
$path = ($_SESSION['customer'] == 'customer') ? "./" : "../";
echo "
...
<hr>
<a href="/Urban-std/main/services/index.php">Back</div>
<script>
