                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th><font color="green">CUSTOMER</font></th>
...
{               ?>                                      
                                        ...
                                        <td>
                                        <b>Lad Registration No:</b>&nbsp;<?php echo htmlentities($result->reg);?><br>
                                        <b>Land Size :</b>&nbsp;<?php echo htmlentities($result->lndsize);?> (Square Metre)<br>
                                        <b>Land Slope :</b>&nbsp;<?php echo htmlentities($result->slope);?><br>
                                        <b>Soil Depth:</b>&nbsp;<?php echo htmlentities($result->depth);?> (Feet)<br>
                                        <b>Recommendation :</b>&nbsp;<?php echo htmlentities($result->recommandation);?><br>
