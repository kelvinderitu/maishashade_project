...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <center><h4 > <font color="red">SITE QUOTATION RECORDS</font></h4></center>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><font color="green">File Report</font></th> 
                                        </tr>
                                    </thead>
                                    <tbody>
...
{               ?>                                      
                        ...
                        <b>No of Floors:</b><br> <?php echo htmlentities($result->floors);?><br><br>
