...
$sql="INSERT INTO  tblcontactusquery(category,name,EmailId,regno,Message) VALUES(:category,:name,:email,:regno,:message)";
...
if($lastInsertId)
{
$msg="Message Sent, Thankyou for your feedback";
}
else 
{
                ...
                <form name="sentMessage"  method="post">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" id="regno" name="regno" readonly value="<?php echo $user['regno']; ?>">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
