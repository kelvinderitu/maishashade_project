...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
               <center> <h4 > <font color="black">MY MESSAGES :</font></h4></center>
...
<?php                                      $sql = "SELECT *FROM tbmessages where user_id='".$_SESSION['GUESTID']."' or  recepient='".$_SESSION['GUESTID']."'";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                <b>Message :</b><?php echo htmlentities($result->message);?><br>
                                                <b>Date :</b><?php echo htmlentities($result->date);?><br>
                                                <b>Sender :</b><?php echo htmlentities($result->sender);?><br>
                                                <a href="reply.php?id=<?php echo $result->id; ?>" class="btn btn-warning btn-exsm">Reply</a>
                                                </td>  
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
                            ...
                            <button class="btn btn-sm btn-warning"><a href="../index.php"><font color="white">Back</font></a></button>
                        </div>
                    </div>
                    <!--End Advanced Tables -->
                </div>
