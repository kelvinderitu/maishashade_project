            ...
            <div class="box box-danger">
                ...
                <div class="box-body table-responsive table-bordered">
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        <div class="container">
                            <div class ="col-md-6"><button class="btn btn-sm btn-primary"><a href="sendmsg.php">
                                    <font color="white"><i class="fa fa-edit"></i>&nbsp;Compose New</font>
                                </a></button></div>
                                <a href="../index.php" class="float-right"><i class="fa fa-arrow-left"></i>&nbsp;Back</a>
                        </div><br>
                        <thead>
                            <tr>
                                <th>#</th>
