            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    if (isset($_POST['driverbtn'])) {
                        ...
                        //update query
                        $qry = "update tbl_bookings set id='$id', cust_name='$customer_name', driver='$driver' where id='$id'";
                    ...
                    ?>
                    <a class="btn btn-info" href="pendingservicepayment.php">Back</a>
                </div><br>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
";
                                    ...
                                    ?>
                                        <form role="form" action="#" method="post">
                                            ...
                                            <input class="form-control" type="hidden" readonly name="cust_name" value='<?php echo $row['cust_name']; ?>' required>
