...
<head>
	...
	<title>Dispatch Manager Panel</title>
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<nav class="navbar navbar-static-top" style="background-color:#ADD8E6">
				...
				<span style="float:left;line-height:50px;color:#fff;padding-left:15px;font-size:18px;">Dispatch Manager Panel</span>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
					...
					<li class="treeview <?php if( ($cur_page == 'product.php') || ($cur_page == 'product-add.php') || ($cur_page == 'product-edit.php') ) {echo 'active';} ?>">
                        <a href="pendingservicepayment.php">
					...
					<li class="treeview <?php if( ($cur_page == 'order.php') ) {echo 'active';} ?>">
                        <a href="allocations.php">
                            <i class="fa fa-users"></i> <span>View  Driver Allocations</span>
                        </a>
                    </li>
