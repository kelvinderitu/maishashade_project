                ...
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            <?php
                            $i = 0;
                            $statement = $pdo->prepare("SELECT * FROM tbl_bookings where payment_status='Approved' or payment_status='Completed' and status='Pending'  ORDER by id DESC");
                            $statement->execute();
                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                            foreach ($result as $row) {
                                $i++;
                                ...
                                <tr class="<?php if ($row['payment_status'] == 'Pending') {
                                    ...
                                    <td>
                                        ...
                                        foreach ($result1 as $row1) {
                                            echo '<b>Product:</b> ' . $row1['servicename'];
                                        }
                                        ?>
                                    ...
                                    <td>
                                        <b>Start Date :</b><?php echo $row['sdate']; ?><br><br>
                                        <b>End Date: </b><?php echo $row['edate']; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                                <a href="schedule.php?id=<?php echo $row['id']; ?>&task=Approved" class="btn btn-warning btn-md">Approve</a>
                                        <?php
                                            }
                                        }
                                        ?>
