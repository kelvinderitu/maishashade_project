...
<div class="container">
<button class="btn btn-sm btn-success"><a href="add_service.php"><font color="white"><i class="fa fa-plus"></i>&nbsp;Add New Service</font></a></button>
</div>
            		...
            		?>
                        ...
                        <td>
                            ...
                            if($row['status']='Active') {
                                    ?>
                                    <a href="active-change-status.php?serviceid=<?php echo $row['serviceid']; ?>&task=Active" class="btn btn-success btn-xs" style="width:100%;margin-bottom:4px;">Set Activate</a>
                                    <?php
                            ...
                            if($row['status']='Inactive') {
                                    ?>
                                    <a href="inactive-change-status.php?serviceid=<?php echo $row['serviceid']; ?>&task=Inactive" class="btn btn-warning btn-xs" style="width:100%;margin-bottom:4px;">Set Inactive</a>
                                    <?php
                            ...
                            if($row['status']='Inactive') {
                                    ?>
                                    <a href="editservice.php?serviceid=<?php echo $row['serviceid']; ?>" class="btn btn-info btn-xs" style="width:100%;margin-bottom:4px;">Edit</a>
                                    <?php
