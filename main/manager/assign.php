        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    if (isset($_POST['locatebtn'])) {
                        $id = $_POST["id"];
                        $cust_name = $_POST["cust_name"];
                        $technician = $_POST["technician"];
                        //update query
                        $qry = "update tbl_bookings set id='$id', cust_name='$cust_name', technician='$technician' where id='$id'";
                    ...
                    ?>
                    <a class="btn btn-info" href="allocations.php">Back</a>
                </div><br>
                <!-- /.col-lg-12 -->
            </div><br>
            <!-- /.row -->
                                        ...
                                        <form role="form" action="#" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="technician" onchange="showLoanDetails(this.value)" class="form-control" required>
                                                    ...
                                                    <?php
                                                    $q1 = mysqli_query($conn, "SELECT * from tbl_staff  where role='technician' and  status='1' ");
                                            ...
                                            <button type="submit" class="btn btn-success " name="locatebtn">Submit</button>
                                        </form>
                                </div>
                            <?php
                                    }
