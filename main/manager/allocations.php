...
<section class="content">
  ...
  <div class="row">
    ...
    <b>Email:</b><br> <?php echo $row['email']; ?><br><br>
                    ...
                    <td><?php echo $row['technician_status']; ?><br>
                    </td>
                    <td>
                    <?php
                                    if($row['lndsize']!=='0'){
                            ...
                            ?>
                    <?php
                                if($row['technician']=='Not Assigned'){
                                    ?>
                                    <a href="assign.php?id=<?php echo $row['id']; ?>&task=Approved" class="btn btn-success btn-md" >Assign Technician</a>
                                    <?php
