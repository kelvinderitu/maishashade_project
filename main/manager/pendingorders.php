                ...
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            <?php
                            $i = 0;
                            $statement = $pdo->prepare("SELECT * FROM tbl_payment WHERE (payment_status != 'Rejected' AND payment_status != 'Pending') AND shipping_status != 'Not Available' AND (supervisor = '' OR technician = '') ORDER by id DESC");
                            $statement->execute();
                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                            foreach ($result as $row) {
                                $i++;
                                ...
                                <tr class="<?php if ($row['payment_status'] == 'Pending') {
                                    ...
                                    <td>
                                        ...
                                        <?php if ($row['technician'] == '' ) : ?>
                                            <a href="technicianallocation.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-xs">Assign Designer</a><br>
                                        <?php endif; ?>
