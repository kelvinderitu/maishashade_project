...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['email']) || empty($_POST['password'])) {
    	...
    	$statement = $pdo->prepare("SELECT * FROM tbl_staff WHERE email=? AND status=? AND role='service manager'");
...
<div class="login-box">
	<div class="login-logo">
		<h3><b>Service Manager Login</b></h3>
	</div>
  	<div class="login-box-body">
		...
		<form action="" method="post">
			...
			<div class="container">
				<button><a href="../login-staff.php" style="color:black;">Back</a><br></button>
	</div>
		</form>
	</div>
</div>
