...
$sql="INSERT INTO  tbmessages(user_id,sender,message) VALUES(:user_id,:sender,:message)";
        ...
        <div class="row">
            <!-- Map Column -->
              <div class="col-lg-8 mb-4">
                ...
                <input type="hidden" class="form-control" id="user_id" name="user_id" readonly value="<?php echo $user['user_id']; ?>">
                   
                            <input type="hidden" class="form-control" id="sender" name="sender" readonly value="inventory manager">
<div class="form-group row mb-3">
                        ...
                        $num = $result->num_rows;		
                        if ($num > 0){
                          echo ' <select required name="user_id" onchange="classArmDropdown(this.value)" class="form-control mb-1">';
                          echo'<option value="">--Select Customer--</option>';
                          while ($rows = $result->fetch_assoc()){
                          echo'<option value="'.$rows['user_id'].'" >'.$rows['cust_name'].'</option>';
                              }
                                  echo '</select>';
                              }
                            ?>  
