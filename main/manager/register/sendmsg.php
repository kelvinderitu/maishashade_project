...
.succWrap{
    ...
    if (str == "") {
        ...
        xmlhttp.open("GET","ajaxClassArms1.php?cid="+str,true);
        xmlhttp.send();
    }
}
</script>
        ...
        <div class="row">
            <!-- Map Column -->
              <div class="col-lg-8 mb-4">
                ...
                <input type="hidden" class="form-control" id="user_id" name="user_id" readonly value="<?php echo $user['cust_id']; ?>">
         
                            <input type="hidden" class="form-control" id="sender" name="sender" readonly value="manager">
                    ...
                    <div class="col-xl-6">
                        ...
                        $num = $result->num_rows;		
                        if ($num > 0){
                          echo ' <select required name="recepient" onchange="classArmDropdown(this.value)" class="form-control mb-1">';
                          echo'<option value="">--Select Customer--</option>';
                          while ($rows = $result->fetch_assoc()){
                            echo "<option value='".$rows['cust_id']."'>".$rows['cust_name']."  ".$rows['cust_lname']." </option>";
                              }
                                  echo '</select>';
                              }
                            ?>  
                        ...
                        <label class="form-control-label">Id<span class="text-danger ml-2">*</span></label>
                            <?php
                                echo"<div cust_name='txtHint'></div>";
                            ?>
                        </div>
                    </div>
                    </div>
