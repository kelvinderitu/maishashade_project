...
$sql="INSERT INTO  candidates(stu_id,fullname,email,phone,address,eventname,charges,position_id,category,transactioncode) VALUES(:stu_id,:fullname,:email,:phone,:address,:eventname,:charges,:position_id,:category,:transactioncode)";
        ...
        <div class="row">
            <!-- Map Column -->
              <div class="col-lg-8 mb-4">
                ...
                <center><h5><b>REGISTER FOR AN EVENT :</b></h5></center>
                ...
                <input type="hidden" class="form-control" id="stu_id" name="stu_id" readonly value="<?php echo $user['id']; ?>">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="hidden" class="form-control" id="category" name="category" readonly value="individual">
