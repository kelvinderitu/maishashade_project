        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table  table-hover table-striped">
            ...
            <tbody>
            	...
            	$i=0;
                $id=$_GET['id']; 
            	$statement = $pdo->prepare("SELECT * FROM tbl_bookings WHERE  photographer_status='Delivered' and id='$id'");
            	$statement->execute();
            	$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
            	foreach ($result as $row) {
            		$i++;
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <b>Land Size:</b><br> <?php echo $row['landsize']; ?><br><br>
                        <b>Building Style:</b><br> <?php echo $row['style']; ?><br><br>
                        <b>No of Floors:</b><br> <?php echo $row['floors']; ?><br><br>
                        </td>
                        <td>
                        <b>Permit Cost :</b><br> <?php echo $row['permit']; ?><br>
                        <b>Material Cost:</b><br> <?php echo $row['materialcost']; ?><br><br>
                        <b>Labour Cost:</b><br> <?php echo $row['labourcost']; ?><br><br>

                        <b>TOTAL ESTIMATED COST:</b>  <br>Ksh <?php echo $row['labourcost']+$row['materialcost']+$row['permit']; ?><br><br>
                        </td>
                        <td>
                        <?php echo $row['repstats']; ?>
                        </td>
                        <td>
                        <?php
                                if($row['repstats']=='Pending'){
                                    ?>
                                    <a href="rep-change-status.php?id=<?php echo $row['id']; ?>&task=Approved" class="btn btn-success btn-xs" style="width:100%;margin-bottom:4px;">Approve</a>
                                    <?php
                                }
                            ?>
                    </td>
