...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">ASSIGN ENGINEER </h3>
                    <a class="btn btn-info" href="engineerallocations.php">Back</a>
                </div><br>
                <!-- /.col-lg-12 -->
            </div><br>
            <!-- /.row -->
...
?>                                    
                                    <form role="form" action="allocateengineer.php" method="post">
...
<div class="form-group">
<div class="font-italic">Engineer<span style="color:red">*</span></div>

<select name="engineer" onchange="showLoanDetails(this.value)" class="form-control" required>
<option value="">Select</option>
<?php
$q1=mysqli_query($conn,"SELECT * from tbl_staff  where role='engineer' and  status='1' ");
