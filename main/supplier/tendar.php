        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
            	<?php
            	$i=0;
            	$statement = $pdo->prepare("SELECT * FROM requests ORDER by id DESC");
            	$statement->execute();
            	$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
            	foreach ($result as $row) {
            		$i++;
					...
					<tr>
                        ...
                        <?php
                                if($row['charges']=='0'){
                                    ...
                                    ?>
                                       <a href="addp.php?id=<?php echo $row['id']; ?>&task=Approved" class="btn btn-success btn-xs" >Add Price</a>
                                    <?php
                                }}
                            ?>                  
                        </td>
                        ...
                        <?php
                                if($row['inventoryStatus']=='Pending'){
                                    ?>
                                       <a href="app-supplies-stats.php?id=<?php echo $row['id']; ?>&task=Approved" class="btn btn-success btn-xs" >Approve</a>
                                    <?php
                                }
                            ?>  <br>
                             <?php
                                if($row['inventoryStatus']=='Confirmed'){
                                    ?>
                                       <a href="supp-supplies-stats.php?id=<?php echo $row['id']; ?>&task=Supplied" class="btn btn-success btn-xs" >Supply</a>
                                    <?php
                                }
                            ?>                
                        </td>
