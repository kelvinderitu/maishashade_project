...
<section class="content-header">
    <div class="content-header-left">
        <h3>Product Supplies Payment</h3>
    </div>
</section>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                            <a href="receivepay2.php?id=<?php echo $row['id']; ?>&task=Received" class="btn btn-success btn-xs">Received</a>
                                        <?php
                                        }
                                        ?><br>
                                    </td>
                                    <td>
                                        ...
                                        ?>
                                            <a href="receipt2.php?id=<?php echo $row['id']; ?>&task=Received" class="btn btn-success btn-xs">My Receipt</a>
                                        <?php
                                        }
                                        ?><br>
                                    </td>
