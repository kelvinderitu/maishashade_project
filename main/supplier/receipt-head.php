	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">Kenya Clay Products</span>
			</a>
    		...
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
                    ...
                    <li class="treeview <?php if( ($cur_page == 'product.php') || ($cur_page == 'product-add.php') || ($cur_page == 'product-edit.php') ) {echo 'active';} ?>">
                        <a href="tendar.php">
                            <i class="fa fa-book"></i> <span>Available Tendars</span>
                        </a>
                    </li>
					<li class="treeview <?php if( ($cur_page == 'product.php') || ($cur_page == 'product-add.php') || ($cur_page == 'product-edit.php') ) {echo 'active';} ?>">
                        <a href="mytenders.php">
                            <i class="fa fa-book"></i> <span>My Tendar Status</span>
                        </a>
                    </li>

					<li class="treeview <?php if( ($cur_page == 'order.php') ) {echo 'active';} ?>">
                        <a href="pending_payments.php">
                            <i class="fa fa-briefcase"></i> <span>Pending Payment</span>
                        </a>
                    </li>
					<li class="treeview <?php if( ($cur_page == 'order.php') ) {echo 'active';} ?>">
                        <a href="approved_payments.php">
                            <i class="fa fa-briefcase"></i> <span>Approved Payment</span>
                        </a>
                    </li>
					<li class="treeview <?php if( ($cur_page == 'order.php') ) {echo 'active';} ?>">
                        <a href="receipt.php">
                            <i class="fa fa-book"></i> <span>Receipt</span>
                        </a>
                    </li>
