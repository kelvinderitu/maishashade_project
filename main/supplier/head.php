...
<div class="header">
	<div class="container">
		<div class="row inner">
			...
			<h3>KENYA CLAY PRODUCTS</h3><br>
			Sukari Ranch Nairobi/ Rd,<br>
			Po Box 236-00232 Ruiru, <br>
			Thika, Kenya<br>
			Phone: +254 020 2011805<br>
			Email: kenyaclayproducts@.com
			<hr>
			</div><br>
            ...
            ?>
                        ...
                        <?php 
                            echo $pagination; 
                        ?>
						<td><b>Date :</b><?php echo $row['payment_date']; ?><br><br>
                                        <b>Customer Name :</b><?php echo $row['customer_name']; ?><br><br></td>
