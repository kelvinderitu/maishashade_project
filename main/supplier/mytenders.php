            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <?php echo $row['payment_status']; ?>
                            <?php
                                if($row['payment_status']==''){
                                    ?>
                                       <a href="payment-change-status.php?id=<?php echo $row['id']; ?>&task=Approved" class="btn btn-success btn-xs" style="width:100%;margin-bottom:4px;">Approve</a>
                                    <?php
                                }
                            ?>
                             <?php
                        ...
                        <td>
                           <b>Transaction Id :</b> <?php echo $row['transactioncode']; ?><br>
                            <b>Total Amount :</b><?php echo $row['total_amount']; ?>
                            <br><br>
                        ...
                        <td>  <?php
                                if($row['status']=='Approved'){
                                    ?>
                                    <a href="supply_goods.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-xs" style="width:100%;margin-bottom:4px;">Supply</a>
                                    <?php
                                }
                            ?>
                        </td>
