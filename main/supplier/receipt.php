...
?><div class="container">
  <h3>Ecoways mechanized powder coating</h3><br>
  Jogoo road Ahero street<br>
			Po Box 236-00232  <br>
			Phone: 0722 501975<br>
        ...
        <div class="box-body table-responsive">
          <table id="" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
            	...
            	$i=0;
                $id=$_GET['id'];
            	$statement = $pdo->prepare("SELECT * FROM requests where id='$id'");
            	$statement->execute();
            	$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
            	foreach ($result as $row) {
            		$i++;
                    ...
                    <?php
	                    ...
	                    <td><?php echo $i; ?></td>
	                    <td>
                        <b>Name :</b> <?php echo $row['varietyName']; ?><br>
                        <b>Quantity :</b> <?php echo $row['quantity']; ?><br>
                        <b>Price Per Quantity  :</b><?php echo $row['charges']; ?>
                          
                        </td>
                       
                        <td>
                           <b>Transaction Id :</b> <?php echo $row['Ref']; ?><br>
                            <b>Total Amount :</b><?php echo $row['charges']*$row['quantity']; ?>
                            <br><br>
