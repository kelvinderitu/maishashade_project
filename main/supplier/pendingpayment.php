        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
            	<?php
            	$i=0;
            	$statement = $pdo->prepare("SELECT * FROM tbl_request_material WHERE status='Pending'ORDER by id DESC");
            	$statement->execute();
            	$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
            	foreach ($result as $row) {
            		$i++;
                       ...
                       <b>Price : </b><?php echo $row['price']; ?>
                        ...
                        <td>
                            ...
                            if($row['status']=='Pending') {
                                    ?>
                                    <a href="editform.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-xs" style="width:100%;margin-bottom:4px;">Set Status</a>
                                    <?php
