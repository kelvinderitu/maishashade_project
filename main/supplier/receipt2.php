...
<center><img src="../assets/uploads/log.png"></center>
<br>
                    ...
                    <table id="" class="table ">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    <center>
                                        ...
                                        foreach ($result1 as $row1) {
                                            echo '<br><b>Supplier:</b> ' . $row1['full_name'];
                                ...
                                <td>
                                    <center>
                                        <b>Product :</b> <?php echo $row['p_name']; ?><br>
                                        <b>Quantity :</b> <?php echo $row['quantity']; ?> <br>
                                        <b>Price Per Quantity :</b> Ksh <?php echo $row['charges']; ?><br>
