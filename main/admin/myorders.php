        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
            	<?php
            	$i=0;
            	$statement = $pdo->prepare("SELECT * FROM tbl_tender_application where status ='Received'  ");
            	$statement->execute();
            	$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
            	foreach ($result as $row) {
            		$i++;
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <?php
                           ...
                           $statement1->execute(array($row['subject']));
                           $result1 = $statement1->fetchAll(PDO::FETCH_ASSOC);
                           foreach ($result1 as $row1) {
                                echo '<b>Name:</b> '.$row1['full_name'];
                                echo '<br><b>Phone No:</b> '.$row1['phone'];
                        ...
                        <b>Quantity (Kgs):</b> <?php echo $row['quantity']; ?><br>
                        <b>Price :</b> <?php echo $row['price']; ?><br>
                        </td>
                        <td>
                        <b> Ksh :</b><?php echo $row['quantity']*$row['price']; ?>
                        </td><!--
                        <td>
                        ...
                        <td>        
                        <a href="editform.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger"><i class="fa fa-edit "></i> Reject</button> 
                        <a href="updatematerial.php?id=<?php echo $row['id']; ?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> UPDATE</button> 
                        </td>
