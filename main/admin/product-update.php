				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<div class="col-sm-4">
								<select type="hidden" name="tcat_id" class="form-control select2 top-cat">
						...
						<input type="hidden" name="ecat_id" class="form-control" value="<?php echo $ecat_id; ?>">
						<input type="hidden" name="p_name" class="form-control" value="<?php echo $p_name; ?>">
						<input type="hidden" name="p_old_price" class="form-control" value="<?php echo $p_old_price; ?>">
						<input type="hidden" name="p_current_price" class="form-control" value="<?php echo $p_current_price; ?>">


						<script>
							function loanamount() {
								var original = document.getElementById("pqty").value;
								var day = document.getElementById("newnum").value;
