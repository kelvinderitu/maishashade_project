...
<section class="content-header">
    <div class="content-header-left">
        <h3>SPECIALS ORDERS MATERIALS REQUEST</h3>
    </div>
</section>
                ...
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            <?php
                            $i = 0;
                            $statement = $pdo->prepare("SELECT * FROM tbl_requestedspecialordermaterials ORDER by id DESC");
                            $statement->execute();
                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                            foreach ($result as $row) {
                                $i++;
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                                <a href="specialorderrejected.php?id=<?php echo $row['id']; ?>&task=Rejected" class="btn btn-success btn-xs" style="width:100%;margin-bottom:4px;">Reject</a>
                                        <?php
                                        ...
                                        ?>
                                                <a href="specialorderapprovedmaterials.php?id=<?php echo $row['id']; ?>&task=Approved" class="btn btn-primary btn-xs" style="width:100%;margin-bottom:4px;">Approve</a>
                                        <?php
