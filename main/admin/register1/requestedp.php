...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 > <font color="black">REQUESTED MATERIALS:</font></h4>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><font color="green">Requested Quantity</font></th>
                                            <th><font color="green">Packed Quantity (Kgs)</font></th>
                                            <th><font color="green">Number of Bags (Pcs)</font></th>
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo htmlentities($result->weight*$result->bags);?> Kgs</td>  
                                ...
                                if($result->status=='Waiting For Approval'){
                                    ?>
                                   <a href="update2.php?varietyName=<?php echo $result->varietyName; ?>&task=Released" class="btn btn-warning btn-sm" >Approve</a>
                                    <?php
                                }
                            ?>
