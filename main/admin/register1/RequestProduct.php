...
if (isset($_POST['send'])) {
    $varietyName = $_POST['p_name'];
    $product_price = $_POST['product_price'];
    $quantity = $_POST['quantity'];
    $specs = $_POST['specs'];
    $supplier = $_POST['supplier'];
    $DueDate = $_POST['DueDate'];
    $sql = "INSERT INTO  requestsproduct(p_name,product_price,quantity,specs,supplier,DueDate) VALUES(:p_name,:product_price,:quantity,:specs,:supplier,:DueDate)";
    $query = $dbh->prepare($sql);
    $query->bindParam(':p_name', $varietyName, PDO::PARAM_STR);
        ...
        <div class="row">
            ...
            <div class="col-lg-8 mb-4">
                ...
                <form name="sentaddress" method="post">
                    ...
                    <input type="hidden" class="form-control" id="sender" name="p_name">


                    <div class="control-group form-group">
                        <label>Insert Product </label>
                        <div class="controls">
                            <input name="p_name" type="text" required class="form-control">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <label>PRICE PER UNIT</label>
                        <div class="controls">
                            <input name="product_price" type="number" required class="form-control">
                        </div>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            <textarea rows="5" cols="36" name="specs" required class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                            <label class="form-control-label">Select Supplier<span class="text-danger ml-2">*</span></label>
                            <?php
                            $qry = "SELECT * FROM tbl_staff where role='supplier' and status='1'";
                            ...
                            if ($num > 0) {
                                ...
                                while ($rows = $result->fetch_assoc()) {
                                    echo '<option value="' . $rows['email'] . '" >' . $rows['full_name'] . '</option>';
                                }
                                echo '</select>';
                            }
                            ?>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            <input name="DueDate" type="date" min="<?php echo date('Y-m-d'); ?>" class="form-control" required>
                        </div>
                    </div>
                    <div id="success"></div>
