       ...
       <form class="form-horizontal span6" action="controller.php?action=edit" method="POST"  />
        ...
        <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                            <input class="form-control input-sm" readonly id="OWNERNAME" name="OWNERNAME" placeholder=
...
<div><input type="number" class="form-control" name="PROQTY" readonly="true" id="totalpaid"></div>
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <div class="col-md-3">
                         <input class="form-control input-sm"  readonly id="ORIGINALPRICE" name="ORIGINALPRICE" placeholder=
                            "Original Price" type="hidden" value="<?php echo $singleproduct->ORIGINALPRICE; ?>">
                      </div>
                      <div class="col-md-3">
                         <input class="form-control input-sm"  readonly id="PROPRICE" name="PROPRICE" placeholder=
                            "Price" type="hidden" step="any" value="<?php echo $singleproduct->PROPRICE; ?>">
                      </div>
                    </div>
                  </div>
