				...
				<div class="box box-info">
					<div class="box-body">
						...
						<label for="" class="col-sm-3 control-label">Product Name <span>*</span></label>
                         <?php
                        $qry= "SELECT * FROM tbl_request where completion_status='Order Completed'";
                        $result = $conn->query($qry);
                        $num = $result->num_rows;		
                        if ($num > 0){
                          echo ' <select required name="p_name" onchange="classArmDropdown(this.value)" class=" form-control">';
                          echo'<option value="">--Select Product--</option>';
                          while ($rows = $result->fetch_assoc()){
                          echo'<option value="'.$rows['product_name'].'" >'.$rows['product_name'].'</option>';
                              }
                                  echo '</select>';
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Old Price <br><span style="font-size:10px;font-weight:normal;">(Ksh)</span></label>
							<div class="col-sm-4">
