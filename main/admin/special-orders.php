        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
            	<?php
            	$i=0;
            	$statement = $pdo->prepare("SELECT * FROM tbl_request ORDER by id DESC");
            	$statement->execute();
            	$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
            	foreach ($result as $row) {
            		$i++;
					...
					<tr>
	                    <td><?php echo $i; ?></td>
	                    <td>
                            <b>Id:</b> <?php echo $row['cust_id']; ?><br>
                            <b>Name:</b><br> <?php echo $row['cust_name']; ?><br>
                            <b>Email:</b><br> <?php echo $row['cust_email']; ?><br>
                            <b>Address:</b><br> <?php echo $row['cust_address']; ?><br>

                        </td>
                        <td> <b>Name :</b><br> <?php echo $row['product_name']; ?><br>
                        <b>Quantity :</b><br> <?php echo $row['quantity']; ?><br></td>
                        <td>
                        <b></b><br> <?php echo $row['description']; ?><br>

                        </td>
                        <td><b>Ksh :</b><?php echo $row['charges']; ?></td><!--
                        <td>
                           ...
                           <b>Remark :</b> <?php echo $row['remark']; ?>
                            ...
                            <?php
                                if($row['status']=='Pending'){
                                    ?>
                                    <a href="approverequest.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-xs" style="width:100%;margin-bottom:4px;">Change Status</a>
                                    <?php
                                }
                            ?>
                        </td>
                     
                        <td><?php echo $row['completion_status']; ?><br><br>
                        <?php
                                if($row['completion_status']=='Order Completed'){
                                    ?>
                                    <a href="product-upload.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-xs" style="width:100%;margin-bottom:4px;">Upload Product</a>
                                    <?php
                                }
                            ?>
                    </td>
