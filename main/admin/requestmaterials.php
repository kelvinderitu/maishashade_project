...
$sql="INSERT INTO  tbl_tender(full_name,product_name,quantity,description) VALUES(:full_name,:product_name,:quantity,:description)";
...
if($lastInsertId)
{
$msg="Tender was Added Successfully.";
}
else 
{
    ...
    <div class="container">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="myorders.php"><i class="fa fa-arrow-left"></i>&nbsp;Back</a>
            </li>
        ...
        <div class="row">
            <!-- Map Column -->
              <div class="col-lg-8 mb-4">
                ...
                <center><h5><b>NEW TENDER :</b></h5></center>
                ...
                <input type="hidden" class="form-control" id="full_name" name="full_name" readonly value="<?php echo $user['full_name']; ?>">
                   ...
                   <!-- <div class="form-group row mb-3">
                        ...
                        if ($num > 0){
                          ...
                          echo'<option value="'.$rows['id'].'" >'.$rows['full_name'].'</option>';
                              }
                                  echo '</select>';
                              }
                            ?>  
                        ...
                        $num = $result->num_rows;		
                        if ($num > 0){
                          echo ' <select required name="product_name" onchange="classArmDropdown(this.value)" class="form-control mb-1">';
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>Product Quantity (In Numbers):</label>
