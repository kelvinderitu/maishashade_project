                ...
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            <?php
                            $i = 0;
                            $statement = $pdo->prepare("SELECT * FROM tbl_payment WHERE technician_return='returned'");
                            $statement->execute();
                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                            <a href="returnorderstatus.php?id=<?php echo $row['id']; ?>&task=confirmed" class="btn btn-success btn-xs" style="width:85%;margin-bottom:4px;">Confirm</a>
                                        <?php
                                            // Update quantity when Confirm button is clicked
                                            $toolbox_name = $row['toolbox_type'];
