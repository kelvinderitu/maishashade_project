...
<div class="page">
    <div class="container">
                ...
                <?php else : ?>
                    ...
                    <div class="cart">
                        <table class="table table-responsive table-hover table-bordered">
                            ...
                            <tr>
                                <th colspan="7" class="total-text">Ksh</th>
        ...
        <div class="clear"></div>
        <h3 class="special">COMPLETE THE SECTION BELOW:</h3>
        <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            <label for=""><?php echo "CHOOSE YOUR ANY OF THE BANK  ACCOUNT TO USE" ?> *</label>
                        ...
                        <form action="payment/bank/init2.php" method="post" id="bank_form">
                            <div class="container"><b>Total Amount</b><br>
                                <input type="text" readonly name="amount" value="<?php echo $final_total; ?>">
                            </div>

                            <div class="col-md-12 form-group">
                                <label for=""><?php echo "select the bank account number you chose to bank " ?></span></label><br>
                                <?php
                                $statement = $pdo->prepare("SELECT * FROM tbl_settings WHERE id=1");
                                $statement->execute();
                                $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                            ...
                            <div class="col-md-12 form-group">
                                <label for="">Bank Name <br><span style="font-size:12px;font-weight:normal;">(Input the bank name Correctly)</span></label>
                                <textarea name="BankName"  required class="form-control" cols="30" rows="2"></textarea>
                            </div>
                            <div class="col-md-12 form-group">
