                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <font color="green">Designation</font>
                                                </th>
                                                <th>
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            <?php if ($result->status == 1) { ?>
                                                                <a href="approvedstaff.php?inid=<?php echo htmlentities($result->id); ?>"> <button class="btn btn-danger btn-sm"> Deactivate</button>
                                                                <?php } else { ?>

                                                                    <a href="approvedstaff.php?id=<?php echo htmlentities($result->id); ?>"><button class="btn btn-primary btn-sm"> Approve</button>
                                                                    <?php } ?>
