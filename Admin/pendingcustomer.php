    ...
    <body>
        ...
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4>
                        <font color="black">PENDING CUSTOMERS REGISTRATION</font>
                    </h4>
                                            ...
                                            foreach ($results as $result) {               ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center">
                                                        ...
                                                        <?php } else { ?>
                                                            <a href="pendingcustomer.php?incust_id=<?php echo htmlentities($result->cust_id); ?>"> <button class="btn btn-danger btn-sm"> Rejected</button>
