...
if($lastInsertId)
{
$msg="Dispatch Manager  Added successfully";
}
else 
{
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                   <center> <h4><b>New Dispatch Manager :</b></h4></center>
                                                </div>
                                            </div>
...
<input type="hidden"  name="role" class="form-control"  id="role" value="dispatch" >
