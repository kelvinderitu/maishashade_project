...
<section class="content-header">
	<div class="content-header-left">
		<center><h4>SERVICES PAYMENT REPORT</h4></center>
	</div>
</section>
<div class="container">
          ...
          <table id="example1" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
            	...
            	foreach ($result as $row) {
            		$i++;
            		?>
					<tr class="<?php if($row['payment_status']=='Approved'){echo 'bg-r';}else{echo 'bg-g';} ?>">
	                    <td><?php echo $i; ?></td>
	                    <td>
                        ...
                        <b>Amount paid :</b> Ksh  <?php echo $row['charges']+$row['fee']; ?><br></td>
                        <td>
