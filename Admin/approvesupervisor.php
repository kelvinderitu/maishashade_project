...
$query -> execute();
header('location:approvesupervisor.php');
}
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
               <center> <h4 > <font color="black">ACTIVE SUPERVISOR ACCOUNT:</font></h4></center>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT * from staff where status='1' and role='supervisor' ";
$query = $dbh -> prepare($sql);
$query->execute();
...
<?php if($result->status==1)
 {?>
<a href="approvesupervisor.php?instaff_id=<?php echo htmlentities($result->staff_id);?>"  >  <button class="btn btn-danger btn-sm"> Deactivate</button>
<?php } else {?>

                                            <a href="approvesupervisor.php?staff_id=<?php echo htmlentities($result->staff_id);?>" ><button class="btn btn-success btn-sm"> Activate</button> 
                                            <?php } ?>
