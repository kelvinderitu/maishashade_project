...
$query -> execute();
header('location:inactivedriver.php');
}
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
               <center> <h4 > <font color="black">INACTIVE DRIVER ACCOUNT:</font></h4></center>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT * from staff where status='2' and role='driver' ";
$query = $dbh -> prepare($sql);
$query->execute();
...
<?php if($result->status==1)
 {?>
<a href="inactivedriver.php?instaff_id=<?php echo htmlentities($result->staff_id);?>"  >  <button class="btn btn-danger btn-sm"> Deactivate</button>
<?php } else {?>

                                            <a href="inactivedriver.php?staff_id=<?php echo htmlentities($result->staff_id);?>" ><button class="btn btn-success btn-sm"> Activate</button> 
                                            <?php } ?>
