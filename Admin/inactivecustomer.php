        ...
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <center>
                        <h4>
                            <font color="black">INACTIVE CUSTOMER ACCOUNT:</font>
                        </h4>
                    </center>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php $sql = "SELECT * from tbl_customer where cust_status='2'";
                                        $query = $dbh->prepare($sql);
                                        $query->execute();
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center">
                                                        <?php if ($result->cust_status == 1) { ?>
                                                            <a href="inactivecustomer.php?incust_id=<?php echo htmlentities($result->cust_id); ?>"> <button class="btn btn-danger btn-sm"> Deactivate</button>
                                                            <?php } else { ?>
