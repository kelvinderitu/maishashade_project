...
<section class="content-header">
	<div class="content-header-left">
        ...
        <h3>SUPPLIES REPORT</h3></center>
	</div>
</section>
<div class="container float-right">
    <button id="printButton" onclick="printPage()"><font color="black"><i class="fa fa-print"></i>&nbsp;Generate report</font></button>
    <style>
        .button-container {
            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr>
                      ...
                      <b>Price  </b><?php echo $row['charges']; ?> Ksh                  
                        </td>
