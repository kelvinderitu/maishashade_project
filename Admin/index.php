...
echo "<script type='text/javascript'> document.location = 'dashboard.php'; </script>";
  ...
  echo  "<font color='red'><b><p class='text-center '>Invalid Details !! Please Try Again or Contact Administrator </b></p></font>";
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								<form method="post">
									...
									<input type="email" placeholder="Enter Your Email Address" name="username" class="form-control mb" required>

									<label for="" class="text-uppercase text-sm">Password</label>
									<input type="password" placeholder="Password" name="password" class="form-control mb" required><br>
									<button class="btn btn-primary btn-block" name="login" type="submit">LOGIN&nbsp;<i class="fa fa-sign-in"></i></button><br>
