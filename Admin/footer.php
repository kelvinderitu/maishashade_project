	...
	<script src="includes/js/jquery-2.2.4.min.js"></script>
	...
	<script src="includes/js/jquery.inputmask.js"></script>
	<script src="includes/js/jquery.inputmask.date.extensions.js"></script>
	<script src="includes/js/jquery.inputmask.extensions.js"></script>
	...
	<script src="includes/js/jquery.sparkline.min.js"></script>
	...
	<script src="includes/js/on-off-switch.js"></script>
    <script src="includes/js/on-off-switch-onload.js"></script>
