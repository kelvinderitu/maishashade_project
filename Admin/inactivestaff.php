...
$query -> execute();
header('location:inactivestaff.php');
}
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
               <center> <h4 > <font color="black">INACTIVE  STAFF ACCOUNT:</font></h4></center>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT * from tbl_staff where status='2'  ";
$query = $dbh -> prepare($sql);
$query->execute();
...
<?php if($result->status==1)
 {?>
<a href="inactivestaff.php?inid=<?php echo htmlentities($result->id);?>"  >  <button class="btn btn-danger btn-sm"> Deactivate</button>
<?php } else {?>

                                            <a href="inactivestaff.php?id=<?php echo htmlentities($result->id);?>" ><button class="btn btn-success btn-sm"> Activate</button> 
                                            <?php } ?>
