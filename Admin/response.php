...
if($action == 'login') {
    ...
    $query = "SELECT * FROM `admin` WHERE username='$username' AND `password` = '$pass_encrypt'";
...
if($action == 'add_user') {
	...
	/* Bind parameters. TYpes: s = string, i = integer, d = double,  b = blob */
	$stmt->bind_param('sssss',$user_fname,$user_lname,$user_phone,$user_email,$user_gender,$user_city,$user_username,$user_password);
